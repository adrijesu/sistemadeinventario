                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="descripcion" id="descripcion_producto" class="form-control" cols="30" rows="2" disabled></textarea>
                                                </div>
                                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo $contador_de_compras;?>" name="" id="nro_compra" hidden>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="" id="comprobante" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="" id="precio_compra_controlador" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="" id="stock_actual" style="background-color: #fff019; text-align: center" class="form-control" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="">usuario</label>
                            <input type="text" name="" id="" class="form-control" value="<?php echo $email_sesion; ?>" disabled>
                        </div>
                    </div>
