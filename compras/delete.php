                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <input type="text" name="" value="<?php echo $id_producto; ?>" id="id_producto" hidden>
            ...
            <div class="card card-outline card-primary">
              ...
              <div class="card-body">
                ...
                <hr>
                    <div class="col-md-12">
                        <div class="form-group">
                            <button class="btn btn-danger btn-block" id="btn_eliminar"><i class="fa fa-trash"></i> Eliminar compra</button>
                        </div> 
                    </div>
